VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} Frm_SheetCopy 
   Caption         =   "情報"
   ClientHeight    =   4095
   ClientLeft      =   120
   ClientTop       =   465
   ClientWidth     =   6480
   OleObjectBlob   =   "Frm_SheetCopy.frx":0000
   StartUpPosition =   1  'オーナー フォームの中央
End
Attribute VB_Name = "Frm_SheetCopy"
...
Private Sub UserForm_Initialize()
  ...
  Frm_SheetCopy.copySheet.AddItem "≪新規シート≫"
  For Each objSheet In ActiveWorkbook.Sheets
    If objSheet.Visible = True Then
      Frm_SheetCopy.copySheet.AddItem objSheet.Name
    End If
  Next
  Frm_SheetCopy.copySheet.ListIndex = 0
  Set cBox = Nothing
