...
' * @author Bunpei.Koizumi<bunpei.koizumi@gmail.com>
'**************************************************************************************************
Function CalAddDay(ByVal chkDate As Date, Optional ByVal addDay As Integer = 1) As Date
  Dim startDayCnt As Integer
  ...
  Call Library.showDebugForm(funcName, , "start1")
  Call Library.showDebugForm("chkDate", chkDate, "debug")
  ...
  For startDayCnt = 1 To addDay
    chkDate = DateAdd("d", 1, chkDate)
    
    '休日判定
    Call GetHollyday(chkDate, HollydayName)
    ...
    Call Library.showDebugForm("HollydayName", HollydayName, "debug")
    Call Library.showDebugForm("chkDate", chkDate, "debug")
    
    If HollydayName <> "" Then
      'chkDate = DateAdd("d", 1, chkDate)
      chkDate = Library.CalAddDay(chkDate, 1)
    End If
  Next
...
' * @author Bunpei.Koizumi<bunpei.koizumi@gmail.com>
'**************************************************************************************************
Function covCells2String(targetCell As Range) As String
  Dim targetLen As Long
  Dim getStr As String
  Dim targetVal As Variant
  
  getStr = ""
  For Each targetVal In targetCell
    If getStr = "" Then
      getStr = targetVal.value
    Else
      getStr = getStr & "," & targetVal.value
    End If
  Next

  covCells2String = getStr
End Function
