...
'    'Call Ctl_ProgressBar.showCount("オプション設定値格納", line, Sh_wbsConfig.Range("B5"), Sh_wbsConfig.Range("A" & line) & ":" & getVal(Sh_wbsConfig.Range("A" & line)))
...
'    Call Ctl_ProgressBar.showCount("オプション設定値格納", line, Sh_wbsConfig.Range("B5"), "ショートカットキー設定")
'
...
'  Call Menu.M_ショートカット設定
  ...
  Call WBS_Option.設定シートコピー("forWBS")
