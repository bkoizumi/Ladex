...
'******************************************************************************
Public Function GetHollyday(ByVal targetdate As Date, HollydayName As String) As Boolean
    kaerichi = False
    HollydayName = ""
    ...
    If HollydayName = "" Then
      ...
      End If
    End If
    Call Library.showDebugForm("HollydayName[" & Format(targetdate, "m/d") & "]", HollydayName, "debug")
...
Dim targetday As Integer
    ...
    Case 11
        ...
        End If
    Case 12
        If targetyear > 1988 And targetyear <= 2019 Then
            If targetday = 23 Then
                hantei = True
                HollydayName = "“Vc’a¶“ú"
            End If
...
Public Function TokubetsunaKyujitsu(targetdate As Date, HollydayName As String) As Boolean
    ...
    '‰ïĞw’è‹x“ú‚Ìİ’è
    endLine = Sh_PARAM.Cells(Rows.count, 8).End(xlUp).Row
    For line = 3 To endLine
      If targetdate = Sh_PARAM.Range("H" & line) Then
