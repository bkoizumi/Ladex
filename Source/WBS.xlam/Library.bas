...
' * @author Bunpei.Koizumi<bunpei.koizumi@gmail.com>
'**************************************************************************************************
Function errorHandle(Optional funcName As String)
...
Function endScript()
 ...
 'アクティブセルの選択
  If SelectionCell <> "" And resetCellFlg = True Then
    ActiveWorkbook.Worksheets(SelectionSheet).Select
    ActiveWorkbook.Worksheets(SelectionSheet).Range(SelectionCell).Select
  End If
...
Function execDel(srcPath As String)
  ...
  Set FSO = CreateObject("Scripting.FileSystemObject")
  Call showDebugForm("削除対象", srcPath, "debug")
...
'==================================================================================================
Function 罫線_破線_囲み(Optional SetArea As Range, Optional lineColor As Variant = 0, Optional WeightVal = xlHairline)
  Dim Red As Long, Green As Long, Blue As Long
...
'==================================================================================================
Function 罫線_破線_格子(Optional SetArea As Range, Optional lineColor As Variant = 0, Optional WeightVal = xlHairline)
  Dim Red As Long, Green As Long, Blue As Long
...
'==================================================================================================
Function 罫線_破線_左(Optional SetArea As Range, Optional lineColor As Variant = 0, Optional WeightVal = xlHairline)
  Dim Red As Long, Green As Long, Blue As Long
...
'==================================================================================================
Function 罫線_破線_右(Optional SetArea As Range, Optional lineColor As Variant = 0, Optional WeightVal = xlHairline)
  Dim Red As Long, Green As Long, Blue As Long
...
'==================================================================================================
Function 罫線_破線_左右(Optional SetArea As Range, Optional lineColor As Variant = 0, Optional WeightVal = xlHairline)
  Dim Red As Long, Green As Long, Blue As Long
...
'==================================================================================================
Function 罫線_破線_上(Optional SetArea As Range, Optional lineColor As Variant = 0, Optional WeightVal = xlHairline)
  Dim Red As Long, Green As Long, Blue As Long
...
'==================================================================================================
Function 罫線_破線_下(Optional SetArea As Range, Optional lineColor As Variant = 0, Optional WeightVal = xlHairline)
  Dim Red As Long, Green As Long, Blue As Long
...
'==================================================================================================
Function 罫線_破線_上下(Optional SetArea As Range, Optional lineColor As Variant = 0, Optional WeightVal = xlHairline)
  Dim Red As Long, Green As Long, Blue As Long
...
'==================================================================================================
Function 罫線_破線_垂直(Optional SetArea As Range, Optional lineColor As Variant = 0, Optional WeightVal = xlHairline)
  Dim Red As Long, Green As Long, Blue As Long
...
'==================================================================================================
Function 罫線_破線_水平(Optional SetArea As Range, Optional lineColor As Variant = 0, Optional WeightVal = xlHairline)
  Dim Red As Long, Green As Long, Blue As Long
...
'==================================================================================================
Function 罫線_実線_囲み(Optional SetArea As Range, Optional lineColor As Variant = 0, Optional WeightVal = xlThin)
  Dim Red As Long, Green As Long, Blue As Long
...
'==================================================================================================
Function 罫線_実線_格子(Optional SetArea As Range, Optional lineColor As Variant = 0, Optional WeightVal = xlThin)
  Dim Red As Long, Green As Long, Blue As Long
...
'==================================================================================================
Function 罫線_実線_左(Optional SetArea As Range, Optional lineColor As Variant = 0, Optional WeightVal = xlThin)
  Dim Red As Long, Green As Long, Blue As Long
...
'==================================================================================================
Function 罫線_実線_右(Optional SetArea As Range, Optional lineColor As Variant = 0, Optional WeightVal = xlThin)
  Dim Red As Long, Green As Long, Blue As Long
...
'==================================================================================================
Function 罫線_実線_左右(Optional SetArea As Range, Optional lineColor As Variant = 0, Optional WeightVal = xlThin)
  Dim Red As Long, Green As Long, Blue As Long
...
'==================================================================================================
Function 罫線_実線_上(Optional SetArea As Range, Optional lineColor As Variant = 0, Optional WeightVal = xlThin)
  Dim Red As Long, Green As Long, Blue As Long
...
'==================================================================================================
Function 罫線_実線_下(Optional SetArea As Range, Optional lineColor As Variant = 0, Optional WeightVal = xlThin)
  Dim Red As Long, Green As Long, Blue As Long
...
'==================================================================================================
Function 罫線_実線_上下(Optional SetArea As Range, Optional lineColor As Variant = 0, Optional WeightVal = xlThin)
  Dim Red As Long, Green As Long, Blue As Long
...
'==================================================================================================
Function 罫線_実線_垂直(Optional SetArea As Range, Optional lineColor As Variant = 0, Optional WeightVal = xlThin)
  Dim Red As Long, Green As Long, Blue As Long
...
'==================================================================================================
Function 罫線_実線_水平(Optional SetArea As Range, Optional lineColor As Variant = 0, Optional WeightVal = xlThin)
  Dim Red As Long, Green As Long, Blue As Long
...
'==================================================================================================
Function 罫線_二重線_囲み(Optional SetArea As Range, Optional lineColor As Variant = 0, Optional WeightVal = xlThin)
  Dim Red As Long, Green As Long, Blue As Long
...
'==================================================================================================
Function 罫線_二重線_左(Optional SetArea As Range, Optional lineColor As Variant = 0, Optional WeightVal = xlThin)
  Dim Red As Long, Green As Long, Blue As Long
...
'==================================================================================================
Function 罫線_二重線_左右(Optional SetArea As Range, Optional lineColor As Variant = 0, Optional WeightVal = xlThin)
  Dim Red As Long, Green As Long, Blue As Long
...
'==================================================================================================
Function 罫線_二重線_上(Optional SetArea As Range, Optional lineColor As Variant = 0, Optional WeightVal = xlThin)
  Dim Red As Long, Green As Long, Blue As Long
...
'==================================================================================================
Function 罫線_二重線_下(Optional SetArea As Range, Optional lineColor As Variant = 0, Optional WeightVal = xlThin)
  Dim Red As Long, Green As Long, Blue As Long
...
'==================================================================================================
Function 罫線_二重線_上下(Optional SetArea As Range, Optional lineColor As Variant = 0, Optional WeightVal = xlThin)
  Dim Red As Long, Green As Long, Blue As Long
...
'==================================================================================================
Function 罫線_破線_逆L字(Optional SetArea As Range, Optional lineColor As Variant = 0, Optional WeightVal = xlThin)
  Dim Red As Long, Green As Long, Blue As Long
...
' * @author Bunpei.Koizumi<bunpei.koizumi@gmail.com>
'**************************************************************************************************
Function CalAddDay(ByVal startDay As Date, Optional ByVal addDay As Single = 1, Optional ByVal addType As String = "hour", Optional ByVal addColType As String = "start") As Date
  Dim loopDayCnt As Integer
  Dim HollydayName As String
  Dim addDayInt As Integer
  Dim addDayFix As Single
  'Dim startDay As Date
  Dim endDay As Date, loopDay As Date
  
  Const funcName As String = "Library.CalAddDay"
  HollydayName = "default"
  
  
  Call Library.showDebugForm(funcName, , "start1")
  Call Library.showDebugForm("addType ", addType, "debug")
  Call Library.showDebugForm("startDay", Format(startDay, "yyyy/mm/dd hh:nn:ss"), "debug")
  Call Library.showDebugForm("addDay  ", addDay, "debug")
  
  
  If Format(startDay, "h") = 0 Then
    startDay = Format(startDay, "yyyy/mm/dd 09:00:00")
  End If
  Call Library.showDebugForm("startDay", Format(startDay, "yyyy/mm/dd hh:nn:ss"), "debug")
  
  If addType = "hour" Then
    addDayInt = Int(addDay)
    If addDayInt > 1 Then addDayInt = addDayInt - 1
    addDayFix = 11 * (addDay - Int(addDay))
    
    endDay = DateAdd("d", addDayInt, startDay)
    endDay = DateAdd("h", addDayFix, endDay)
  
  ElseIf addType = "day" Then
    addDayInt = Int(addDay)
    addDayFix = 0
...
'  Call Library.showDebugForm("addDay    ", addDay, "debug")
'  Call Library.showDebugForm("addDayInt ", addDayInt, "debug")
'  Call Library.showDebugForm("addDayFix ", addDayFix, "debug")
'  Call Library.showDebugForm("startDay  ", Format(startDay, "yyyy/mm/dd hh:nn:ss"), "debug")
'  Call Library.showDebugForm("endDay    ", Format(endDay, "yyyy/mm/dd hh:nn:ss"), "debug")
'  Call Library.showDebugForm("DateDiff-d", DateDiff("d", startDay, endDay), "debug")
'  Call Library.showDebugForm("DateDiff-h", DateDiff("h", startDay, endDay), "debug")
  
  loopDayCnt = 0
  loopDay = startDay
  
  Do While DateDiff("d", loopDay, endDay) <> 0
    loopDay = DateAdd("d", loopDayCnt, startDay)
    
'    Call Library.showDebugForm("startDay ", Format(startDay, "yyyy/mm/dd hh:nn:ss"), "debug")
'    Call Library.showDebugForm("endDay   ", Format(endDay, "yyyy/mm/dd hh:nn:ss"), "debug")
'    Call Library.showDebugForm("loopDay  ", Format(loopDay, "yyyy/mm/dd hh:nn:ss"), "debug")
    
    
    '休日判定
    Call GetHollyday(loopDay, HollydayName)
...
'      Call Library.showDebugForm("endDay    ", Format(endDay, "yyyy/mm/dd hh:nn:ss"), "debug")
    ...
    End If
    loopDayCnt = loopDayCnt + 1
  Loop

  If addColType = "end" And Format(endDay, "h") < 14 Then
    endDay = Format(endDay, "yyyy/mm/dd 18:nn:ss")
  End If
  
  If Format(endDay, "h") >= 18 Then
    endDay = Format(endDay, "yyyy/mm/dd 18:nn:ss")
  End If
...
Sub testCalAddDay()
  ...
  testDay = Library.CalAddDay(Range("M8"), Range("S8"))
  Call Library.showDebugForm("testDay", Format(testDay, "yyyy/mm/dd hh:nn:ss"), "debug")
